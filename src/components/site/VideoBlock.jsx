...
export default function VideoBlock() {
  ...
  return (
    <section className="relative w-full bg-[#1c1c1e] rounded-[2.5rem] border border-neutral-800 shadow-[0_20px_50px_rgba(0,0,0,0.35)] pt-16 pb-8 px-5 md:px-8 mt-16 mb-4">
